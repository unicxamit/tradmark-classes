...
import TestPage1 from "../app/pannels/public-user/components/pages/testPage1";
import TestPage2 from "../app/pannels/public-user/components/pages/testPage2";
import TestPage3 from "../app/pannels/public-user/components/pages/testPage3";
import TestPage4 from "../app/pannels/public-user/components/pages/testPage4";
import TestPage5 from "../app/pannels/public-user/components/pages/testPage5";
...
import tdClass01 from "../app/pannels/public-user/components/tdClassesPages/tdClass01";
import TdClass01 from "../app/pannels/public-user/components/tdClassesPages/tdClass01";
...
function PublicUserRoutes() {
  return (
    <Routes>
      ...
      <Route
        path={publicUser.calculator.CALCULATOR_ALL}
        element={<AllCalculator />}
      />
      <Route
        path={publicUser.calculator.GSTCalculator}
        element={<GSTCalculator />}
      />
      <Route
        path={publicUser.calculator.ITRCalculator}
        element={<ITRCalculator />}
      />
      <Route
        path={publicUser.calculator.EPFCalculator}
        element={<EPFCalculator />}
      />
      <Route
        path={publicUser.calculator.NPSCalculator}
        element={<NPSCalculator />}
      />
      <Route
        path={publicUser.calculator.HRACalculator}
        element={<HRACalculator />}
      />
      <Route
        path={publicUser.calculator.SIPCalculator}
        element={<SIPCalculator />}
      />
      <Route
        path={publicUser.calculator.GratuityCalculator}
        element={<GratuityCalculator />}
      />
      <Route
        path={publicUser.calculator.RetirementCalculator}
        element={<RetirementCalculator />}
      />
      <Route
        path={publicUser.calculator.RDCalculator}
        element={<RDCalculator />}
      />
      <Route
        path={publicUser.calculator.SimpleInterestCalculator}
        element={<SimpleInterestCalculator />}
      />
      <Route
        path={publicUser.calculator.TDSCalculator}
        element={<TDSCalculator />}
      />
      <Route
        path={publicUser.calculator.PPFCalculator}
        element={<PPFCalculator />}
      />
      <Route
        path={publicUser.calculator.MutualFundCalculator}
        element={<MutualFundCalculator />}
      />
      <Route
        path={publicUser.calculator.EMICalculator}
        element={<EMICalculator />}
      />
      <Route
        path={publicUser.calculator.FDCalculator}
        element={<FDCalculator />}
      />
      <Route
        path={publicUser.calculator.HomeEMICalculator}
        element={<HomeEMICalculator />}
      />
      <Route
        path={publicUser.calculator.LumpsumCalculator}
        element={<LumpsumCalculator />}
      />
      <Route
        path={publicUser.calculator.BusinessCalculator}
        element={<BusinessCalculator />}
      />
      ...
      {/* Existing Blog Detail Route */}
      <Route path={publicUser.blog.DETAIL} element={<BlogDetailPage />} />
      {/* New Route for Case Study Detail Page */}
      <Route
        path={publicUser.blog.DETAIL + "/:id"}
        element={<BlogDetailPage />}
      />

      <Route path={publicUser.blog.DETAILS} element={<BlogDetailsPage />} />
      {/* New Route for blogs Detail Page */}
      <Route
        path={publicUser.blog.DETAILS + "/:id"}
