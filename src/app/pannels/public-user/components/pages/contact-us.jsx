                    ...
                    <div className="contact-info">
                      <div className="contact-info-section">
                        <div className="c-info-column">
                          ...
                          <p>
                            702, 7th Floor, Shagun Arcade, AB Road, Vijay Nagar
                        ...
                        <div className="c-info-column">
                          ...
                          <p>
                            <a href="tel:+216-761-8331">+91 - 9993993909</a>
                          </p>
                          <p>
                            <a href="tel:+216-761-8331">+91 - 9009980049</a>
                          </p>
                        </div>
                        <div className="c-info-column">
                          <div className="c-info-icon">
